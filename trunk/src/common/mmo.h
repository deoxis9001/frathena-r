...
#ifndef PACKETVER
	// Date du client (Par default 2011-06-09 pour frAthena-R)
...
#define MAX_PARTY 24 // Utile pour des qu黎es comme Olknir etc...
...
#define MAX_HOMUNCULUS_CLASS	52	//[orn]
...
struct mmo_charstatus {
	...
	short costume_low,costume_mid,costume_top;
	short robe;
